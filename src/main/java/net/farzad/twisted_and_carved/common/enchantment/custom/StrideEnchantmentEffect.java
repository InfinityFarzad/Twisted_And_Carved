...
public record StrideEnchantmentEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<StrideEnchantmentEffect> CODEC = MapCodec.unit(StrideEnchantmentEffect::new);
