...
public record TwistingEnchantmentEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<TwistingEnchantmentEffect> CODEC = MapCodec.unit(TwistingEnchantmentEffect::new);
