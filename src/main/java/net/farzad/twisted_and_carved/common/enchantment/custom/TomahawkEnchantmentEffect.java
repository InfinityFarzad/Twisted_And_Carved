...
public record TomahawkEnchantmentEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<TomahawkEnchantmentEffect> CODEC = MapCodec.unit(TomahawkEnchantmentEffect::new);
