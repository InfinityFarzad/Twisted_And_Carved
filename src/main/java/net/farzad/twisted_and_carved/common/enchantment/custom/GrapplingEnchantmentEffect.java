...
public record GrapplingEnchantmentEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<GrapplingEnchantmentEffect> CODEC = MapCodec.unit(GrapplingEnchantmentEffect::new);
