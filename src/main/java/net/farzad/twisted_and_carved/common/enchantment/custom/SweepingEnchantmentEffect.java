...
public record SweepingEnchantmentEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<SweepingEnchantmentEffect> CODEC = MapCodec.unit(SweepingEnchantmentEffect::new);
