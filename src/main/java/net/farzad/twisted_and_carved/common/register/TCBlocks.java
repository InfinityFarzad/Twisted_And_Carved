...
public class TCBlocks {
    ...
    public static final Block TWISTED_SAPLING = registerBlock("twisted_sapling",
            properties -> new TwistedSaplingBlock(TCSaplingGenerators.TWISTED_TREE, properties.nonOpaque()
    ...
    public static final Block KARMIUM_RAILING = registerBlock("karmium_railing", properties -> new KarmiumFence(properties.strength(2.0f).nonOpaque().requiresTool().sounds(BlockSoundGroup.NETHERITE)),true);
