...
public class TwistedToolPiecePlacer {
    ...
    public static void init() {
        ...
        LootTableEvents.MODIFY.register((key, tableBuilder, source, registries) -> {
            if (key == LootTables.DESERT_PYRAMID_ARCHAEOLOGY) {
                tableBuilder.modifyPools(poolBuilder -> poolBuilder
                        .with(ItemEntry.builder(ModItems.TWISTED_GLAIVE_PIECE)));
            }
            ...
            if (LootTables.JUNGLE_TEMPLE_CHEST.equals(key)) {
                LootPool.Builder poolBuilder = LootPool.builder()
                        ...
                        .with(ItemEntry.builder(ModItems.TWISTED_FALCHION_PIECE))
        ...
        TradeOfferHelper.registerWanderingTraderOffers(factories ->
                factories.addOffersToPool(Identifier.of(TwistedAndCarved.MOD_ID,"scythe_trade"), (entity, random) -> new TradeOffer(
                        new TradedItem(Items.EMERALD,25),
                        Optional.of(new TradedItem(Items.WHEAT, 5)),
                        new ItemStack(ModItems.TWISTED_SCYTHE_PIECE),
                        1,20,0.075f)));
    }
