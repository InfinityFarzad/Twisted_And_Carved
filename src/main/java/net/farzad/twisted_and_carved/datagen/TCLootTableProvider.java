...
public class TCLootTableProvider extends FabricBlockLootSubProvider {
    public TCLootTableProvider(FabricPackOutput dataOutput, CompletableFuture<HolderLookup.Provider> registryLookup) {
